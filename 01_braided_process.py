...
from channelbelt2d.processes import BraidedRiverDeposition
...
if make_animation:
    ...
    try:
        for i in range(number_of_belts):
            ...
            # Save frame
            plt.savefig(f"braided_{i:03d}.png", dpi=gif_target_dimensions[0]/8, bbox_inches='tight')
    except ValueError:
